...
int main(int argc, char const *argv[])
{
	...
	while(1)
	{
		...
		if(f==NULL)
		{
			...
			sendto(s,temp,sizeof temp,0,(struct sockaddr*)&client,len);

			break;
		}
		char temp2[] = "Enter 1. Search 2. Replace 3. Reorder 4. Exit: ";
		//write(ns,temp2,sizeof temp2);
		sendto(s,temp2,sizeof temp2,0,(struct sockaddr*)&client,len);
		...
		recvfrom(s,&choice,sizeof(choice),0,(struct sockaddr*)&client,&len);
		...
		switch(choice)
		{
			...
			recvfrom(s,buf1,sizeof(buf1),0,(struct sockaddr*)&client,&len);
			recvfrom(s,buf2,sizeof(buf2),0,(struct sockaddr*)&client,&len);
			...
			if(i)
			{
				...
				sendto(s,temp3,sizeof temp3,0,(struct sockaddr*)&client,len);
			...
			else
			{
				...
				sendto(s,temp4,sizeof temp4,0,(struct sockaddr*)&client,len);
